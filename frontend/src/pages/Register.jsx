      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">OpenDataX</span>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Join the largest ML dataset marketplace
            </p>
          </div>
          ...
          <form onSubmit={onSubmitHandler} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                required
              >
                <option value="buyer">Buyer - I want to purchase datasets</option>
                <option value="seller">Seller - I want to sell datasets</option>
